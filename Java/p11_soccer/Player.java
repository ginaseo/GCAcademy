...
public class Player {
	...
	public Player(String player_id, String player_name, String team_id, String e_player_name, String nickname,
			String join_yyyy, String position, int back_no, String nation, Date birth_date, String solar, int height,
			int weight) {
		super();
	...
	public String toString() {
		return "Player [player_id=" + player_id + ", player_name=" + player_name + ", team_id=" + team_id
				+ ", e_player_name=" + e_player_name + ", nickname=" + nickname + ", join_yyyy=" + join_yyyy
				+ ", position=" + position + ", back_no=" + back_no + ", nation=" + nation + ", birth_date="
				+ birth_date + ", solar=" + solar + ", height=" + height + ", weight=" + weight + "]";
	}
